...
lib.ssMetadata = [
		{name:"match shape game_atlas_1", frames: [[1026,234,114,144],[1243,234,89,144],[1142,234,99,144],[1197,380,78,144],[1026,380,84,144],[1277,380,66,144],[1112,380,83,144],[1026,0,680,232],[0,770,1297,579],[0,0,1024,768]]}
];
...
(lib.CachedBmp_10 = function() {
	this.initialize(ss["match shape game_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(256.4,16.05,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_9();
	this.instance_1.setTransform(216.15,16.05,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_8();
	this.instance_2.setTransform(170.9,16.05,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_7();
	this.instance_3.setTransform(120.35,16.05,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_6();
	this.instance_4.setTransform(82.45,16.05,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_5();
	this.instance_5.setTransform(53.9,16.05,0.5,0.5);

	this.instance_6 = new lib.CachedBmp_4();
	this.instance_6.setTransform(16.6,16.05,0.5,0.5);

	this.instance_7 = new lib.CachedBmp_3();
	this.instance_7.setTransform(-5,-5,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-5,-5,340,116);
...
// stage content:
(lib.matchshapegame = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// burung
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(5,1,1).p("ABfiWQAjA/AJA1QADAXgCAUIh1A1AhWhAQAKAPAHAPQAaAzgFAqIhcAoAgwA7QgEAtg/AvACMAJQgFA7hRA7ACMAJIhiguAgwA7IhNgl");
	...
	this.shape_28.graphics.f("#08390F").s().p("EBK4AQnQiMiMhDiqQgnhjgOhtQAOBtAnBjMirCAAAIDN9WIWZC6IHiBEIP9CCMA9PAIQIEZApIHOA8IVqDBIAAg4IBzAMIAAteINIn7IChCnICaRrIGyJDQgJhAAAhEQAAl9ENkMIAcgaQDQjDESgmQBEgKBIAAQF9AAENENQEOEMAAF9QAAF9kOENQkNEOl9AAQl8AAkOkOg");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_2.png?1706461006069", id:"CachedBmp_2"},
		{src:"images/match shape game_atlas_1.png?1706461006027", id:"match shape game_atlas_1"}
	],
	preloads: []
};
